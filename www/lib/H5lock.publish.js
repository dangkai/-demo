(function(){
        ...
        H5lock.prototype.createCircle = function() {// 创建解锁点的坐标，根据canvas的大小来平均分配半径
            ...
            var count = 0;
            this.r = this.ctx.canvas.width / (4 + 4 * n);// 公式计算
            this.lastPoint = [];
            this.arr = [];
            this.restPoint = [];
            var r = this.r;
        ...
        H5lock.prototype.initDom = function(){
            ...
            var str = '<canvas id='+this.canvasId+' width='+this.width+' height='+this.height+' style="display: inline-block;margin-top: 1em;margin-left:1.7em"></canvas>';
